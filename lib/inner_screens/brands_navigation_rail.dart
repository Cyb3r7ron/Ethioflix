import 'package:ethio_flix/provider/products.dart';
...
class _BrandNavigationRailScreenState extends State<BrandNavigationRailScreen> {
  ...
  void didChangeDependencies() {
    ...
    if (_selectedIndex == 3) {
      setState(() {
        brand = 'Sebastopol Cinema';
      });
    }
    if (_selectedIndex == 4) {
      setState(() {
        brand = 'Beherawi Theatre';
      });
    }
    if (_selectedIndex == 5) {
      setState(() {
                    ...
                    child: NavigationRail(
                      ...
                      destinations: [
                        buildRotatedTextRailDestination(
                            'Century Cinema', padding),
                        buildRotatedTextRailDestination("Gast Cinema", padding),
                        buildRotatedTextRailDestination("Alem Cinema", padding),
                        buildRotatedTextRailDestination(
                            "Sebastopol Cinema", padding),
                        buildRotatedTextRailDestination(
                            "Beherawi Theatre", padding),
                        buildRotatedTextRailDestination("Hager Fikir", padding),
                        buildRotatedTextRailDestination("Adot Cinema", padding),
          ...
          child: productsBrand.isEmpty
              ? Column(
                  ...
                  children: [
                    ...
                    Text(
                      'No movies related to this cinema',
