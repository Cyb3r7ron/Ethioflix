                          ...
                          children: [
                            ...
                            DropdownButton<String>(
                              items: [
                                ...
                                DropdownMenuItem<String>(
                                  child: Text('Century Cinema'),
                                  value: 'Century Cinema',
                                ),
                                DropdownMenuItem<String>(
                                  child: Text('Gast Cinema'),
                                  value: 'Gast Cinema',
                                ),
                                DropdownMenuItem<String>(
                                ...
                                DropdownMenuItem<String>(
                                  child: Text('Sebastopol Cinema'),
                                  value: 'Sebastopol Cinema',
                                ),
                                DropdownMenuItem<String>(
                                  child: Text('Beherawi Theatre'),
                                  value: 'Beherawi Theatre',
                                ),
                                DropdownMenuItem<String>(
                                  child: Text('Hager Fikir'),
                                  value: 'Hager Fikir',
                                ),
                                DropdownMenuItem<String>(
                                  child: Text('Adot'),
